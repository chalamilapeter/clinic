...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        $users = [
            ...
            //doctors
            ['role_id' => 2, 'number' => 'MD/1748/2021', 'email'=>'keta@clinic.com', 'password' => Hash::make('doctor2021')],
            ['role_id' => 2, 'number' => 'MD/1098/2021', 'email'=>'peter@clinic.com', 'password' => Hash::make('doctor2021')],
            ['role_id' => 2, 'number' => 'MD/1758/2021', 'email'=>'pierre@clinic.com', 'password' => Hash::make('doctor2021')],

            //patients
            ['role_id' => 3, 'number' => 'PA/1748/2021', 'email'=>'benja@clinic.com', 'password' => Hash::make('patient2021')],
            ['role_id' => 3, 'number' => 'PA/1123/2021', 'email'=>'nicky@clinic.com', 'password' => Hash::make('patient2021')],
            ['role_id' => 3, 'number' => 'PA/1548/2021', 'email'=>'stany@clinic.com', 'password' => Hash::make('patient2021')],


            //Lab Technicians
            ['role_id' => 4, 'number' => 'LT/1098/2021', 'email'=>'tave@clinic.com', 'password' => Hash::make('technician2021')],
            ['role_id' => 4, 'number' => 'LT/2025/2021', 'email'=>'ben@clinic.com', 'password' => Hash::make('technician2021')],
